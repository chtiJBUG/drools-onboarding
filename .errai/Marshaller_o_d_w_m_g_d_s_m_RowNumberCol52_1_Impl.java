...
public class Marshaller_o_d_w_m_g_d_s_m_RowNumberCol52_1_Impl implements GeneratedMarshaller<RowNumberCol52> {
  ...
  public RowNumberCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public RowNumberCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(RowNumberCol52.class, objId);
    }
    RowNumberCol52 entity = new RowNumberCol52();
  ...
  public String marshall(RowNumberCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.RowNumberCol52\",\"^ObjectID\"");
