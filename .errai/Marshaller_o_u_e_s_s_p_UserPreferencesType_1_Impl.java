...
public class Marshaller_o_u_e_s_s_p_UserPreferencesType_1_Impl implements GeneratedMarshaller<UserPreferencesType> {
  ...
  public String marshall(UserPreferencesType a0, MarshallingSession a1) {
    ...
    return json.append(a0 != null ? new StringBuilder(64).append("{\"^EncodedType\":\"org.uberfire.ext.services.shared.preferences.UserPreferencesType\",\"^EnumStringValue\":\"").append(a0.name()).append("\"}") : "null").toString();
  }
