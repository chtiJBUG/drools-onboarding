...
public class Marshaller_o_k_w_c_s_d_e_DataObjectDeletedEvent_1_Impl implements GeneratedMarshaller<DataObjectDeletedEvent> {
  private DataObjectDeletedEvent[] EMPTY_ARRAY = new DataObjectDeletedEvent[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataObjectDeletedEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataObjectDeletedEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataObjectDeletedEvent.class, objId);
    }
    DataObjectDeletedEvent entity = new DataObjectDeletedEvent();
  ...
  public String marshall(DataObjectDeletedEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataObjectDeletedEvent\",\"^ObjectID\"");
