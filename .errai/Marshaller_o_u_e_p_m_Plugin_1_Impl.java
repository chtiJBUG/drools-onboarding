...
public class Marshaller_o_u_e_p_m_Plugin_1_Impl implements GeneratedMarshaller<Plugin> {
  ...
  public String marshall(Plugin a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.plugin.model.Plugin\",\"^ObjectID\"");
