...
public class Marshaller_o_k_w_c_s_d_e_DataObjectSelectedEvent_1_Impl implements GeneratedMarshaller<DataObjectSelectedEvent> {
  private DataObjectSelectedEvent[] EMPTY_ARRAY = new DataObjectSelectedEvent[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataObjectSelectedEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataObjectSelectedEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataObjectSelectedEvent.class, objId);
    }
    DataObjectSelectedEvent entity = new DataObjectSelectedEvent();
  ...
  public String marshall(DataObjectSelectedEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataObjectSelectedEvent\",\"^ObjectID\"");
