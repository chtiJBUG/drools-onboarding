...
public class Marshaller_o_d_d_d_Quarter_1_Impl implements GeneratedMarshaller<Quarter> {
  ...
  public String marshall(Quarter a0, MarshallingSession a1) {
    ...
    return json.append(a0 != null ? new StringBuilder(64).append("{\"^EncodedType\":\"org.dashbuilder.dataset.date.Quarter\",\"^EnumStringValue\":\"").append(a0.name()).append("\"}") : "null").toString();
  }
