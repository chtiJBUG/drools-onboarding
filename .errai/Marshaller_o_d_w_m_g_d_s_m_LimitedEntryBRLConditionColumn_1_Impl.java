...
public class Marshaller_o_d_w_m_g_d_s_m_LimitedEntryBRLConditionColumn_1_Impl implements GeneratedMarshaller<LimitedEntryBRLConditionColumn> {
  ...
  public LimitedEntryBRLConditionColumn[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public LimitedEntryBRLConditionColumn demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(LimitedEntryBRLConditionColumn.class, objId);
    }
    LimitedEntryBRLConditionColumn entity = new LimitedEntryBRLConditionColumn();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("definition")) && (!obj.get("definition").isNull())) {
      a1.setAssumedElementType("org.drools.workbench.models.datamodel.rule.IPattern");
    ...
    if ((obj.containsKey("childColumns")) && (!obj.get("childColumns").isNull())) {
      a1.setAssumedElementType("org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn");
  ...
  public String marshall(LimitedEntryBRLConditionColumn a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.LimitedEntryBRLConditionColumn\",\"^ObjectID\"");
