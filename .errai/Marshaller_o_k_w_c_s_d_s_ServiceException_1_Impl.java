...
public class Marshaller_o_k_w_c_s_d_s_ServiceException_1_Impl implements GeneratedMarshaller<ServiceException> {
  private ServiceException[] EMPTY_ARRAY = new ServiceException[0];
  ...
  public ServiceException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ServiceException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ServiceException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    ServiceException entity = new ServiceException(c0);
  ...
  public String marshall(ServiceException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.service.ServiceException\",\"^ObjectID\"");
