...
public class Marshaller_o_k_w_c_s_d_e_DataObjectChangeEvent_1_Impl implements GeneratedMarshaller<DataObjectChangeEvent> {
  private DataObjectChangeEvent[] EMPTY_ARRAY = new DataObjectChangeEvent[0];
  ...
  public DataObjectChangeEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public DataObjectChangeEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataObjectChangeEvent.class, objId);
    }
    DataObjectChangeEvent entity = new DataObjectChangeEvent();
  ...
  public String marshall(DataObjectChangeEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataObjectChangeEvent\",\"^ObjectID\"");
