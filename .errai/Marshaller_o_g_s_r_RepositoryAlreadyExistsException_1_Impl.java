...
public class Marshaller_o_g_s_r_RepositoryAlreadyExistsException_1_Impl implements GeneratedMarshaller<RepositoryAlreadyExistsException> {
  ...
  public RepositoryAlreadyExistsException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(RepositoryAlreadyExistsException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    RepositoryAlreadyExistsException entity = new RepositoryAlreadyExistsException(c0);
  ...
  public String marshall(RepositoryAlreadyExistsException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.structure.repositories.RepositoryAlreadyExistsException\",\"^ObjectID\"");
