...
public class Marshaller_o_d_w_m_d_r_ExpressionMethodParameter_1_Impl implements GeneratedMarshaller<ExpressionMethodParameter> {
  private ExpressionMethodParameter[] EMPTY_ARRAY = new ExpressionMethodParameter[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionMethodParameter[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionMethodParameter demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionMethodParameter.class, objId);
    }
    ExpressionMethodParameter entity = new ExpressionMethodParameter();
  ...
  public String marshall(ExpressionMethodParameter a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionMethodParameter\",\"^ObjectID\"");
