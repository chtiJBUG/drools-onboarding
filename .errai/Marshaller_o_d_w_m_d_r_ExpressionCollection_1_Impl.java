...
public class Marshaller_o_d_w_m_d_r_ExpressionCollection_1_Impl implements GeneratedMarshaller<ExpressionCollection> {
  private ExpressionCollection[] EMPTY_ARRAY = new ExpressionCollection[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionCollection[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionCollection demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionCollection.class, objId);
    }
    ExpressionCollection entity = new ExpressionCollection();
  ...
  public String marshall(ExpressionCollection a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionCollection\",\"^ObjectID\"");
