...
public class Marshaller_o_d_d_d_DataSetDef_1_Impl implements GeneratedMarshaller<DataSetDef> {
  ...
  public String marshall(DataSetDef a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.dashbuilder.dataset.def.DataSetDef\",\"^ObjectID\"");
