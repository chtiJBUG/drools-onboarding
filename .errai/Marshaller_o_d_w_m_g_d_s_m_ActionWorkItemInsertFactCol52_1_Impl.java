...
public class Marshaller_o_d_w_m_g_d_s_m_ActionWorkItemInsertFactCol52_1_Impl implements GeneratedMarshaller<ActionWorkItemInsertFactCol52> {
  ...
  public ActionWorkItemInsertFactCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ActionWorkItemInsertFactCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionWorkItemInsertFactCol52.class, objId);
    }
    ActionWorkItemInsertFactCol52 entity = new ActionWorkItemInsertFactCol52();
  ...
  public String marshall(ActionWorkItemInsertFactCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.ActionWorkItemInsertFactCol52\",\"^ObjectID\"");
