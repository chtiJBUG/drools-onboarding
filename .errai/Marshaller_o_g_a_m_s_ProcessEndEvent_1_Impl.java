...
public class Marshaller_o_g_a_m_s_ProcessEndEvent_1_Impl implements GeneratedMarshaller<ProcessEndEvent> {
  private ProcessEndEvent[] EMPTY_ARRAY = new ProcessEndEvent[0];
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  private Marshaller<Long> java_lang_Long = Marshalling.getMarshaller(Long.class);
  private Marshaller<Map> java_util_Map = Marshalling.getMarshaller(Map.class);
  private Marshaller<List> java_util_List = Marshalling.getMarshaller(List.class);
  public ProcessEndEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public ProcessEndEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ProcessEndEvent.class, objId);
    }
    ProcessEndEvent entity = new ProcessEndEvent();
  ...
  public String marshall(ProcessEndEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.asset.management.social.ProcessEndEvent\",\"^ObjectID\"");
