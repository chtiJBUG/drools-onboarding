...
public class Marshaller_o_u_e_p_m_PluginSimpleContent_1_Impl implements GeneratedMarshaller<PluginSimpleContent> {
  ...
  public PluginSimpleContent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(PluginSimpleContent.class, objId);
    }
    PluginSimpleContent entity = new PluginSimpleContent();
  ...
  public String marshall(PluginSimpleContent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.plugin.model.PluginSimpleContent\",\"^ObjectID\"");
