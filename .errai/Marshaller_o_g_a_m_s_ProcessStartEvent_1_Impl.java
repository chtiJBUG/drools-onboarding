...
public class Marshaller_o_g_a_m_s_ProcessStartEvent_1_Impl implements GeneratedMarshaller<ProcessStartEvent> {
  private ProcessStartEvent[] EMPTY_ARRAY = new ProcessStartEvent[0];
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  private Marshaller<Long> java_lang_Long = Marshalling.getMarshaller(Long.class);
  private Marshaller<Map> java_util_Map = Marshalling.getMarshaller(Map.class);
  private Marshaller<List> java_util_List = Marshalling.getMarshaller(List.class);
  public ProcessStartEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public ProcessStartEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ProcessStartEvent.class, objId);
    }
    ProcessStartEvent entity = new ProcessStartEvent();
  ...
  public String marshall(ProcessStartEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.asset.management.social.ProcessStartEvent\",\"^ObjectID\"");
