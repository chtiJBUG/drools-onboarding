...
public class Marshaller_o_d_d_e_DataSetModifiedEvent_1_Impl implements GeneratedMarshaller<DataSetModifiedEvent> {
  ...
  public String marshall(DataSetModifiedEvent a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.dashbuilder.dataset.events.DataSetModifiedEvent\",\"^ObjectID\"");
