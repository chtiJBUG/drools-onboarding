...
public class Marshaller_o_d_d_d_CSVDataSetDef_1_Impl implements GeneratedMarshaller<CSVDataSetDef> {
  ...
  public CSVDataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    ...
    if ((obj.containsKey("fileURL")) && (!obj.get("fileURL").isNull())) {
      entity.setFileURL(java_lang_String.demarshall(obj.get("fileURL"), a1));
    }
    if ((obj.containsKey("filePath")) && (!obj.get("filePath").isNull())) {
      entity.setFilePath(java_lang_String.demarshall(obj.get("filePath"), a1));
    }
    if ((obj.containsKey("separatorChar")) && (!obj.get("separatorChar").isNull())) {
      entity.setSeparatorChar(java_lang_Character.demarshall(obj.get("separatorChar"), a1));
    }
    if ((obj.containsKey("quoteChar")) && (!obj.get("quoteChar").isNull())) {
      entity.setQuoteChar(java_lang_Character.demarshall(obj.get("quoteChar"), a1));
    }
    if ((obj.containsKey("escapeChar")) && (!obj.get("escapeChar").isNull())) {
      entity.setEscapeChar(java_lang_Character.demarshall(obj.get("escapeChar"), a1));
    }
    if ((obj.containsKey("datePattern")) && (!obj.get("datePattern").isNull())) {
      entity.setDatePattern(java_lang_String.demarshall(obj.get("datePattern"), a1));
    }
    if ((obj.containsKey("numberPattern")) && (!obj.get("numberPattern").isNull())) {
      entity.setNumberPattern(java_lang_String.demarshall(obj.get("numberPattern"), a1));
    }
