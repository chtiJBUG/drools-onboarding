...
public class Marshaller_o_d_w_m_g_d_s_m_BRLConditionVariableColumn_1_Impl implements GeneratedMarshaller<BRLConditionVariableColumn> {
  ...
  public BRLConditionVariableColumn[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static String _$507602885__1195259493_varName(BRLConditionVariableColumn instance) /*-{
    return instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn::varName;
  }-*/;

  private native static void _$507602885__1195259493_varName(BRLConditionVariableColumn instance, String value) /*-{
    instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn::varName = value;
  }-*/;

  private native static String _$507602885__1195259493_factType(BRLConditionVariableColumn instance) /*-{
    return instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn::factType;
  }-*/;

  private native static void _$507602885__1195259493_factType(BRLConditionVariableColumn instance, String value) /*-{
    instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn::factType = value;
  }-*/;
  ...
  public BRLConditionVariableColumn demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(BRLConditionVariableColumn.class, objId);
    }
    BRLConditionVariableColumn entity = new BRLConditionVariableColumn();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("varName")) && (!obj.get("varName").isNull())) {
      _$507602885__1195259493_varName(entity, java_lang_String.demarshall(obj.get("varName"), a1));
    }
    if ((obj.containsKey("factType")) && (!obj.get("factType").isNull())) {
      _$507602885__1195259493_factType(entity, java_lang_String.demarshall(obj.get("factType"), a1));
    }
  ...
  public String marshall(BRLConditionVariableColumn a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.BRLConditionVariableColumn\",\"^ObjectID\"");
