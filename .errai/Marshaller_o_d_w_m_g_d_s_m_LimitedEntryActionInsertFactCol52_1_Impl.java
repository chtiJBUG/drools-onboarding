...
public class Marshaller_o_d_w_m_g_d_s_m_LimitedEntryActionInsertFactCol52_1_Impl implements GeneratedMarshaller<LimitedEntryActionInsertFactCol52> {
  ...
  public LimitedEntryActionInsertFactCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public LimitedEntryActionInsertFactCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(LimitedEntryActionInsertFactCol52.class, objId);
    }
    LimitedEntryActionInsertFactCol52 entity = new LimitedEntryActionInsertFactCol52();
  ...
  public String marshall(LimitedEntryActionInsertFactCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.LimitedEntryActionInsertFactCol52\",\"^ObjectID\"");
