...
public class Marshaller_o_g_c_s_s_e_GenericPortableException_1_Impl implements GeneratedMarshaller<GenericPortableException> {
  private GenericPortableException[] EMPTY_ARRAY = new GenericPortableException[0];
  ...
  public GenericPortableException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public GenericPortableException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(GenericPortableException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    GenericPortableException entity = new GenericPortableException(c0);
  ...
  public String marshall(GenericPortableException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.common.services.shared.exceptions.GenericPortableException\",\"^ObjectID\"");
