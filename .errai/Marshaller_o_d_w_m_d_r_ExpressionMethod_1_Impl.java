...
public class Marshaller_o_d_w_m_d_r_ExpressionMethod_1_Impl implements GeneratedMarshaller<ExpressionMethod> {
  private ExpressionMethod[] EMPTY_ARRAY = new ExpressionMethod[0];
  private Marshaller<Map> java_util_Map = Marshalling.getMarshaller(Map.class);
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionMethod[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionMethod demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionMethod.class, objId);
    }
    ExpressionMethod entity = new ExpressionMethod();
  ...
  public String marshall(ExpressionMethod a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionMethod\",\"^ObjectID\"");
