...
public class Marshaller_o_k_w_c_s_d_e_DataModelerEvent_1_Impl implements GeneratedMarshaller<DataModelerEvent> {
  private DataModelerEvent[] EMPTY_ARRAY = new DataModelerEvent[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataModelerEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataModelerEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataModelerEvent.class, objId);
    }
    DataModelerEvent entity = new DataModelerEvent();
  ...
  public String marshall(DataModelerEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataModelerEvent\",\"^ObjectID\"");
