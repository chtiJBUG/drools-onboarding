...
public class Marshaller_o_d_w_m_g_d_s_m_DTColumnConfig52_1_Impl implements GeneratedMarshaller<DTColumnConfig52> {
  ...
  public DTColumnConfig52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public DTColumnConfig52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DTColumnConfig52.class, objId);
    }
    DTColumnConfig52 entity = new DTColumnConfig52();
  ...
  public String marshall(DTColumnConfig52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.DTColumnConfig52\",\"^ObjectID\"");
