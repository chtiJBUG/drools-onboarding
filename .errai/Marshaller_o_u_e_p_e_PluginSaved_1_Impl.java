...
public class Marshaller_o_u_e_p_e_PluginSaved_1_Impl implements GeneratedMarshaller<PluginSaved> {
  ...
  public PluginSaved demarshall(EJValue a0, MarshallingSession a1) {
    ...
    PluginSaved entity = new PluginSaved(c0, c1, c2);
  ...
  public String marshall(PluginSaved a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.plugin.event.PluginSaved\",\"^ObjectID\"");
