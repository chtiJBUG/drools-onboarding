...
public class Marshaller_o_k_w_c_s_d_e_DataModelSaved_1_Impl implements GeneratedMarshaller<DataModelSaved> {
  private DataModelSaved[] EMPTY_ARRAY = new DataModelSaved[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataModelSaved[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataModelSaved demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataModelSaved.class, objId);
    }
    DataModelSaved entity = new DataModelSaved();
  ...
  public String marshall(DataModelSaved a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataModelSaved\",\"^ObjectID\"");
