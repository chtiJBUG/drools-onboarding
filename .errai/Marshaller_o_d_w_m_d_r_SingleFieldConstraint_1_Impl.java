...
public class Marshaller_o_d_w_m_d_r_SingleFieldConstraint_1_Impl implements GeneratedMarshaller<SingleFieldConstraint> {
  ...
  public SingleFieldConstraint[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public SingleFieldConstraint demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(SingleFieldConstraint.class, objId);
    }
    SingleFieldConstraint entity = new SingleFieldConstraint();
  ...
  public String marshall(SingleFieldConstraint a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.SingleFieldConstraint\",\"^ObjectID\"");
