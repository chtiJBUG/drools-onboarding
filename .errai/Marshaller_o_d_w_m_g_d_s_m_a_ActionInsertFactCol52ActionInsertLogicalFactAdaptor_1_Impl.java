...
public class Marshaller_o_d_w_m_g_d_s_m_a_ActionInsertFactCol52ActionInsertLogicalFactAdaptor_1_Impl implements GeneratedMarshaller<ActionInsertFactCol52ActionInsertLogicalFactAdaptor> {
  ...
  public ActionInsertFactCol52ActionInsertLogicalFactAdaptor[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static ActionInsertFactCol52 _$299171733__$1290599432_action(ActionInsertFactCol52ActionInsertLogicalFactAdaptor instance) /*-{
    return instance.@org.drools.workbench.models.guided.dtable.shared.model.adaptors.ActionInsertFactCol52ActionInsertLogicalFactAdaptor::action;
  }-*/;

  private native static void _$299171733__$1290599432_action(ActionInsertFactCol52ActionInsertLogicalFactAdaptor instance, ActionInsertFactCol52 value) /*-{
    instance.@org.drools.workbench.models.guided.dtable.shared.model.adaptors.ActionInsertFactCol52ActionInsertLogicalFactAdaptor::action = value;
  }-*/;
  ...
  public ActionInsertFactCol52ActionInsertLogicalFactAdaptor demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionInsertFactCol52ActionInsertLogicalFactAdaptor.class, objId);
    }
    ActionInsertFactCol52ActionInsertLogicalFactAdaptor entity = new ActionInsertFactCol52ActionInsertLogicalFactAdaptor();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("action")) && (!obj.get("action").isNull())) {
      _$299171733__$1290599432_action(entity, (ActionInsertFactCol52) ((ObjectMarshaller) java_lang_Object).demarshall(ActionInsertFactCol52.class, obj.get("action"), a1));
    }
