...
public class Marshaller_o_k_w_c_s_d_e_DataObjectFieldSelectedEvent_1_Impl implements GeneratedMarshaller<DataObjectFieldSelectedEvent> {
  private DataObjectFieldSelectedEvent[] EMPTY_ARRAY = new DataObjectFieldSelectedEvent[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataObjectFieldSelectedEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataObjectFieldSelectedEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataObjectFieldSelectedEvent.class, objId);
    }
    DataObjectFieldSelectedEvent entity = new DataObjectFieldSelectedEvent();
  ...
  public String marshall(DataObjectFieldSelectedEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataObjectFieldSelectedEvent\",\"^ObjectID\"");
