...
public class Marshaller_o_d_w_m_d_o_ModelField_1_Impl implements GeneratedMarshaller<ModelField> {
  ...
  public String marshall(ModelField a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.oracle.ModelField\",\"^ObjectID\"");
