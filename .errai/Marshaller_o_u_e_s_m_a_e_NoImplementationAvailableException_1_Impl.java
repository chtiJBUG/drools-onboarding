...
public class Marshaller_o_u_e_s_m_a_e_NoImplementationAvailableException_1_Impl implements GeneratedMarshaller<NoImplementationAvailableException> {
  private NoImplementationAvailableException[] EMPTY_ARRAY = new NoImplementationAvailableException[0];
  ...
  public NoImplementationAvailableException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public NoImplementationAvailableException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(NoImplementationAvailableException.class, objId);
    }
    NoImplementationAvailableException entity = new NoImplementationAvailableException();
  ...
  public String marshall(NoImplementationAvailableException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.security.management.api.exception.NoImplementationAvailableException\",\"^ObjectID\"");
