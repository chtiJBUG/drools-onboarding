...
public class Marshaller_o_u_e_s_m_a_e_GroupNotFoundException_1_Impl implements GeneratedMarshaller<GroupNotFoundException> {
  private GroupNotFoundException[] EMPTY_ARRAY = new GroupNotFoundException[0];
  ...
  public GroupNotFoundException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public GroupNotFoundException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(GroupNotFoundException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("identifier"), a1);
    GroupNotFoundException entity = new GroupNotFoundException(c0);
  ...
  public String marshall(GroupNotFoundException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.security.management.api.exception.GroupNotFoundException\",\"^ObjectID\"");
