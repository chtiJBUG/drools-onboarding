...
public class Marshaller_o_u_e_s_m_a_e_UserNotFoundException_1_Impl implements GeneratedMarshaller<UserNotFoundException> {
  private UserNotFoundException[] EMPTY_ARRAY = new UserNotFoundException[0];
  ...
  public UserNotFoundException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public UserNotFoundException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(UserNotFoundException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("identifier"), a1);
    UserNotFoundException entity = new UserNotFoundException(c0);
  ...
  public String marshall(UserNotFoundException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.security.management.api.exception.UserNotFoundException\",\"^ObjectID\"");
