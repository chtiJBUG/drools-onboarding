...
public class Marshaller_o_d_w_m_d_r_ExpressionFieldVariable_1_Impl implements GeneratedMarshaller<ExpressionFieldVariable> {
  private ExpressionFieldVariable[] EMPTY_ARRAY = new ExpressionFieldVariable[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionFieldVariable[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionFieldVariable demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionFieldVariable.class, objId);
    }
    ExpressionFieldVariable entity = new ExpressionFieldVariable();
  ...
  public String marshall(ExpressionFieldVariable a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionFieldVariable\",\"^ObjectID\"");
