...
public class Marshaller_o_d_w_m_g_d_s_a_InsertRowAuditLogEntry_1_Impl implements GeneratedMarshaller<InsertRowAuditLogEntry> {
  ...
  public InsertRowAuditLogEntry[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public InsertRowAuditLogEntry demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(InsertRowAuditLogEntry.class, objId);
    }
    InsertRowAuditLogEntry entity = new InsertRowAuditLogEntry();
  ...
  public String marshall(InsertRowAuditLogEntry a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.auditlog.InsertRowAuditLogEntry\",\"^ObjectID\"");
