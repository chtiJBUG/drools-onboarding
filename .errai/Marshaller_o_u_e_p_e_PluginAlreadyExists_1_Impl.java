...
public class Marshaller_o_u_e_p_e_PluginAlreadyExists_1_Impl implements GeneratedMarshaller<PluginAlreadyExists> {
  ...
  public String marshall(PluginAlreadyExists a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.plugin.exception.PluginAlreadyExists\",\"^ObjectID\"");
