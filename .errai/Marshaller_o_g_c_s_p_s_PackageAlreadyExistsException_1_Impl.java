...
public class Marshaller_o_g_c_s_p_s_PackageAlreadyExistsException_1_Impl implements GeneratedMarshaller<PackageAlreadyExistsException> {
  private PackageAlreadyExistsException[] EMPTY_ARRAY = new PackageAlreadyExistsException[0];
  ...
  public PackageAlreadyExistsException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public PackageAlreadyExistsException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(PackageAlreadyExistsException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    PackageAlreadyExistsException entity = new PackageAlreadyExistsException(c0);
  ...
  public String marshall(PackageAlreadyExistsException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.common.services.project.service.PackageAlreadyExistsException\",\"^ObjectID\"");
