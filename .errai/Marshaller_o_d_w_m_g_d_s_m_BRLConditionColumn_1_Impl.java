...
public class Marshaller_o_d_w_m_g_d_s_m_BRLConditionColumn_1_Impl implements GeneratedMarshaller<BRLConditionColumn> {
  ...
  public BRLConditionColumn[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public BRLConditionColumn demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(BRLConditionColumn.class, objId);
    }
    BRLConditionColumn entity = new BRLConditionColumn();
  ...
  public String marshall(BRLConditionColumn a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.BRLConditionColumn\",\"^ObjectID\"");
