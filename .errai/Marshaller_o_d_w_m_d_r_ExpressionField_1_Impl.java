...
public class Marshaller_o_d_w_m_d_r_ExpressionField_1_Impl implements GeneratedMarshaller<ExpressionField> {
  private ExpressionField[] EMPTY_ARRAY = new ExpressionField[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionField[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionField demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionField.class, objId);
    }
    ExpressionField entity = new ExpressionField();
  ...
  public String marshall(ExpressionField a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionField\",\"^ObjectID\"");
