...
public class Marshaller_o_d_w_m_d_r_ExpressionGlobalVariable_1_Impl implements GeneratedMarshaller<ExpressionGlobalVariable> {
  private ExpressionGlobalVariable[] EMPTY_ARRAY = new ExpressionGlobalVariable[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionGlobalVariable[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionGlobalVariable demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionGlobalVariable.class, objId);
    }
    ExpressionGlobalVariable entity = new ExpressionGlobalVariable();
  ...
  public String marshall(ExpressionGlobalVariable a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionGlobalVariable\",\"^ObjectID\"");
