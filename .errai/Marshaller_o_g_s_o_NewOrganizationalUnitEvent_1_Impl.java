...
public class Marshaller_o_g_s_o_NewOrganizationalUnitEvent_1_Impl implements GeneratedMarshaller<NewOrganizationalUnitEvent> {
  ...
  public NewOrganizationalUnitEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(NewOrganizationalUnitEvent.class, objId);
    }
    NewOrganizationalUnitEvent entity = new NewOrganizationalUnitEvent();
  ...
  public String marshall(NewOrganizationalUnitEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.structure.organizationalunit.NewOrganizationalUnitEvent\",\"^ObjectID\"");
