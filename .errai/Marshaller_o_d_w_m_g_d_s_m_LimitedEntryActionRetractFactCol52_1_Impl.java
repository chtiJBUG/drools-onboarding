...
public class Marshaller_o_d_w_m_g_d_s_m_LimitedEntryActionRetractFactCol52_1_Impl implements GeneratedMarshaller<LimitedEntryActionRetractFactCol52> {
  ...
  public LimitedEntryActionRetractFactCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public LimitedEntryActionRetractFactCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(LimitedEntryActionRetractFactCol52.class, objId);
    }
    LimitedEntryActionRetractFactCol52 entity = new LimitedEntryActionRetractFactCol52();
  ...
  public String marshall(LimitedEntryActionRetractFactCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.LimitedEntryActionRetractFactCol52\",\"^ObjectID\"");
