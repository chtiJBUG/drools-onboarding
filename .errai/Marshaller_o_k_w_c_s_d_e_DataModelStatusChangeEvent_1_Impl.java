...
public class Marshaller_o_k_w_c_s_d_e_DataModelStatusChangeEvent_1_Impl implements GeneratedMarshaller<DataModelStatusChangeEvent> {
  private DataModelStatusChangeEvent[] EMPTY_ARRAY = new DataModelStatusChangeEvent[0];
  ...
  public DataModelStatusChangeEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public DataModelStatusChangeEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataModelStatusChangeEvent.class, objId);
    }
    DataModelStatusChangeEvent entity = new DataModelStatusChangeEvent();
  ...
  public String marshall(DataModelStatusChangeEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataModelStatusChangeEvent\",\"^ObjectID\"");
