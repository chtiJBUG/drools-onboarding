...
public class Marshaller_o_u_e_s_m_a_e_EntityAlreadyExistsException_1_Impl implements GeneratedMarshaller<EntityAlreadyExistsException> {
  private EntityAlreadyExistsException[] EMPTY_ARRAY = new EntityAlreadyExistsException[0];
  ...
  public EntityAlreadyExistsException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static String _$573197169__1195259493_identifier(EntityAlreadyExistsException instance) /*-{
    return instance.@org.uberfire.ext.security.management.api.exception.EntityAlreadyExistsException::identifier;
  }-*/;

  private native static void _$573197169__1195259493_identifier(EntityAlreadyExistsException instance, String value) /*-{
    instance.@org.uberfire.ext.security.management.api.exception.EntityAlreadyExistsException::identifier = value;
  }-*/;
  ...
  public EntityAlreadyExistsException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(EntityAlreadyExistsException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    final String c1 = java_lang_String.demarshall(obj.get("identifier"), a1);
    EntityAlreadyExistsException entity = new EntityAlreadyExistsException(c0, c1);
    a1.recordObject(objId, entity);
    if ((obj.containsKey("identifier")) && (!obj.get("identifier").isNull())) {
      _$573197169__1195259493_identifier(entity, java_lang_String.demarshall(obj.get("identifier"), a1));
    }
