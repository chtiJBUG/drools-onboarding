...
public class Marshaller_o_d_w_m_g_d_s_m_a_ConditionCol52FieldConstraintAdaptor_1_Impl implements GeneratedMarshaller<ConditionCol52FieldConstraintAdaptor> {
  ...
  public ConditionCol52FieldConstraintAdaptor[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static ConditionCol52 _1656249030__$1643386420_condition(ConditionCol52FieldConstraintAdaptor instance) /*-{
    return instance.@org.drools.workbench.models.guided.dtable.shared.model.adaptors.ConditionCol52FieldConstraintAdaptor::condition;
  }-*/;

  private native static void _1656249030__$1643386420_condition(ConditionCol52FieldConstraintAdaptor instance, ConditionCol52 value) /*-{
    instance.@org.drools.workbench.models.guided.dtable.shared.model.adaptors.ConditionCol52FieldConstraintAdaptor::condition = value;
  }-*/;
  ...
  public ConditionCol52FieldConstraintAdaptor demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ConditionCol52FieldConstraintAdaptor.class, objId);
    }
    ConditionCol52FieldConstraintAdaptor entity = new ConditionCol52FieldConstraintAdaptor();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("condition")) && (!obj.get("condition").isNull())) {
      _1656249030__$1643386420_condition(entity, (ConditionCol52) ((ObjectMarshaller) java_lang_Object).demarshall(ConditionCol52.class, obj.get("condition"), a1));
    }
