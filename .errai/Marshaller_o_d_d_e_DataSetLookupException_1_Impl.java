...
public class Marshaller_o_d_d_e_DataSetLookupException_1_Impl implements GeneratedMarshaller<DataSetLookupException> {
  ...
  private native static String _208463137__1195259493_uuid(DataSetLookupException instance) /*-{
    return instance.@org.dashbuilder.dataset.exception.DataSetLookupException::uuid;
  }-*/;

  private native static void _208463137__1195259493_uuid(DataSetLookupException instance, String value) /*-{
  ...
  public DataSetLookupException demarshall(EJValue a0, MarshallingSession a1) {
    ...
    if ((obj.containsKey("uuid")) && (!obj.get("uuid").isNull())) {
      _208463137__1195259493_uuid(entity, java_lang_String.demarshall(obj.get("uuid"), a1));
    }
