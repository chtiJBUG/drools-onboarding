...
public class Marshaller_o_u_e_s_m_a_e_SecurityManagementException_1_Impl implements GeneratedMarshaller<SecurityManagementException> {
  private SecurityManagementException[] EMPTY_ARRAY = new SecurityManagementException[0];
  ...
  public SecurityManagementException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public SecurityManagementException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(SecurityManagementException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    SecurityManagementException entity = new SecurityManagementException(c0);
  ...
  public String marshall(SecurityManagementException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.ext.security.management.api.exception.SecurityManagementException\",\"^ObjectID\"");
