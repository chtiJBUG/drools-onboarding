...
public class Marshaller_o_u_e_s_m_a_e_OperationFailedException_1_Impl implements GeneratedMarshaller<OperationFailedException> {
  private OperationFailedException[] EMPTY_ARRAY = new OperationFailedException[0];
  ...
  public OperationFailedException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public OperationFailedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(OperationFailedException.class, objId);
    }
    final Integer c0 = java_lang_Integer.demarshall(obj.get("code"), a1);
    final String c1 = java_lang_String.demarshall(obj.get("message"), a1);
    OperationFailedException entity = new OperationFailedException(c0, c1);
