...
public class Marshaller_o_d_d_d_StaticDataSetDef_1_Impl implements GeneratedMarshaller<StaticDataSetDef> {
  ...
  public String marshall(StaticDataSetDef a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.dashbuilder.dataset.def.StaticDataSetDef\",\"^ObjectID\"");
