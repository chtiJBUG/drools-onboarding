...
public class Marshaller_o_d_d_d_BeanDataSetDef_1_Impl implements GeneratedMarshaller<BeanDataSetDef> {
  ...
  public BeanDataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    ...
    if ((obj.containsKey("generatorClass")) && (!obj.get("generatorClass").isNull())) {
      entity.setGeneratorClass(java_lang_String.demarshall(obj.get("generatorClass"), a1));
    }
    if ((obj.containsKey("paramaterMap")) && (!obj.get("paramaterMap").isNull())) {
      a1.setAssumedMapKeyType("java.lang.String");
      a1.setAssumedMapValueType("java.lang.String");
      entity.setParamaterMap(java_util_Map.demarshall(obj.get("paramaterMap"), a1));
