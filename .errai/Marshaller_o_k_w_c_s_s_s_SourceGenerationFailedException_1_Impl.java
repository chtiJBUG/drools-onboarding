...
public class Marshaller_o_k_w_c_s_s_s_SourceGenerationFailedException_1_Impl implements GeneratedMarshaller<SourceGenerationFailedException> {
  private SourceGenerationFailedException[] EMPTY_ARRAY = new SourceGenerationFailedException[0];
  ...
  public SourceGenerationFailedException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public SourceGenerationFailedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(SourceGenerationFailedException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    SourceGenerationFailedException entity = new SourceGenerationFailedException(c0);
  ...
  public String marshall(SourceGenerationFailedException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.services.shared.source.SourceGenerationFailedException\",\"^ObjectID\"");
