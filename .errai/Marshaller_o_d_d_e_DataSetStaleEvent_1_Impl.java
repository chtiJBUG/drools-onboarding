...
public class Marshaller_o_d_d_e_DataSetStaleEvent_1_Impl implements GeneratedMarshaller<DataSetStaleEvent> {
  ...
  public String marshall(DataSetStaleEvent a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.dashbuilder.dataset.events.DataSetStaleEvent\",\"^ObjectID\"");
