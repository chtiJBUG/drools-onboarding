...
public class Marshaller_o_d_w_m_d_r_ActionInsertFact_1_Impl implements GeneratedMarshaller<ActionInsertFact> {
  ...
  public ActionInsertFact[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ActionInsertFact demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionInsertFact.class, objId);
    }
    ActionInsertFact entity = new ActionInsertFact();
  ...
  public String marshall(ActionInsertFact a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ActionInsertFact\",\"^ObjectID\"");
