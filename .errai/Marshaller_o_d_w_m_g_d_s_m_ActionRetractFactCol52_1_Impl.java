...
public class Marshaller_o_d_w_m_g_d_s_m_ActionRetractFactCol52_1_Impl implements GeneratedMarshaller<ActionRetractFactCol52> {
  ...
  public ActionRetractFactCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ActionRetractFactCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionRetractFactCol52.class, objId);
    }
    ActionRetractFactCol52 entity = new ActionRetractFactCol52();
  ...
  public String marshall(ActionRetractFactCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.ActionRetractFactCol52\",\"^ObjectID\"");
