...
public class Marshaller_o_d_w_m_d_r_ExpressionVariable_1_Impl implements GeneratedMarshaller<ExpressionVariable> {
  private ExpressionVariable[] EMPTY_ARRAY = new ExpressionVariable[0];
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  public ExpressionVariable[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static String _$1197564367__1195259493_factType(ExpressionVariable instance) /*-{
    return instance.@org.drools.workbench.models.datamodel.rule.ExpressionVariable::factType;
  }-*/;

  private native static void _$1197564367__1195259493_factType(ExpressionVariable instance, String value) /*-{
    instance.@org.drools.workbench.models.datamodel.rule.ExpressionVariable::factType = value;
  }-*/;
  ...
  public ExpressionVariable demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionVariable.class, objId);
    }
    ExpressionVariable entity = new ExpressionVariable();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("factType")) && (!obj.get("factType").isNull())) {
      _$1197564367__1195259493_factType(entity, java_lang_String.demarshall(obj.get("factType"), a1));
    }
  ...
  public String marshall(ExpressionVariable a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionVariable\",\"^ObjectID\"");
