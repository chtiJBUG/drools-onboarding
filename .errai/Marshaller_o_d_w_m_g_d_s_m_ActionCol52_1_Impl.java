...
public class Marshaller_o_d_w_m_g_d_s_m_ActionCol52_1_Impl implements GeneratedMarshaller<ActionCol52> {
  ...
  public ActionCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ActionCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionCol52.class, objId);
    }
    ActionCol52 entity = new ActionCol52();
  ...
  public String marshall(ActionCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.ActionCol52\",\"^ObjectID\"");
