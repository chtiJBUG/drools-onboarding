...
public class Marshaller_o_d_w_m_g_d_s_m_BRLActionColumn_1_Impl implements GeneratedMarshaller<BRLActionColumn> {
  ...
  public BRLActionColumn[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public BRLActionColumn demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(BRLActionColumn.class, objId);
    }
    BRLActionColumn entity = new BRLActionColumn();
  ...
  public String marshall(BRLActionColumn a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.BRLActionColumn\",\"^ObjectID\"");
