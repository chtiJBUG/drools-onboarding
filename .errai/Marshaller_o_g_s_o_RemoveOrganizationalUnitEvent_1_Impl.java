...
public class Marshaller_o_g_s_o_RemoveOrganizationalUnitEvent_1_Impl implements GeneratedMarshaller<RemoveOrganizationalUnitEvent> {
  ...
  public RemoveOrganizationalUnitEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(RemoveOrganizationalUnitEvent.class, objId);
    }
    RemoveOrganizationalUnitEvent entity = new RemoveOrganizationalUnitEvent();
  ...
  public String marshall(RemoveOrganizationalUnitEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.guvnor.structure.organizationalunit.RemoveOrganizationalUnitEvent\",\"^ObjectID\"");
