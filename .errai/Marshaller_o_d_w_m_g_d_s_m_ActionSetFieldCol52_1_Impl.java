...
public class Marshaller_o_d_w_m_g_d_s_m_ActionSetFieldCol52_1_Impl implements GeneratedMarshaller<ActionSetFieldCol52> {
  ...
  public ActionSetFieldCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ActionSetFieldCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ActionSetFieldCol52.class, objId);
    }
    ActionSetFieldCol52 entity = new ActionSetFieldCol52();
  ...
  public String marshall(ActionSetFieldCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.ActionSetFieldCol52\",\"^ObjectID\"");
