...
public class Marshaller_o_d_d_d_DayOfWeek_1_Impl implements GeneratedMarshaller<DayOfWeek> {
  ...
  public String marshall(DayOfWeek a0, MarshallingSession a1) {
    ...
    return json.append(a0 != null ? new StringBuilder(64).append("{\"^EncodedType\":\"org.dashbuilder.dataset.date.DayOfWeek\",\"^EnumStringValue\":\"").append(a0.name()).append("\"}") : "null").toString();
  }
