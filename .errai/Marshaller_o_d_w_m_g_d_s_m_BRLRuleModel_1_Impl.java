...
public class Marshaller_o_d_w_m_g_d_s_m_BRLRuleModel_1_Impl implements GeneratedMarshaller<BRLRuleModel> {
  ...
  public BRLRuleModel[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  private native static GuidedDecisionTable52 _1396234075__200646685_dtable(BRLRuleModel instance) /*-{
    return instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLRuleModel::dtable;
  }-*/;

  private native static void _1396234075__200646685_dtable(BRLRuleModel instance, GuidedDecisionTable52 value) /*-{
    instance.@org.drools.workbench.models.guided.dtable.shared.model.BRLRuleModel::dtable = value;
  }-*/;
  ...
  public BRLRuleModel demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(BRLRuleModel.class, objId);
    }
    BRLRuleModel entity = new BRLRuleModel();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("dtable")) && (!obj.get("dtable").isNull())) {
      _1396234075__200646685_dtable(entity, org_drools_workbench_models_guided_dtable_shared_model_GuidedDecisionTable52.demarshall(obj.get("dtable"), a1));
    }
