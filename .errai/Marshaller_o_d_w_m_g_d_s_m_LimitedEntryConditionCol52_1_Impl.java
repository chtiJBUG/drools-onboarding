...
public class Marshaller_o_d_w_m_g_d_s_m_LimitedEntryConditionCol52_1_Impl implements GeneratedMarshaller<LimitedEntryConditionCol52> {
  ...
  public LimitedEntryConditionCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public LimitedEntryConditionCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(LimitedEntryConditionCol52.class, objId);
    }
    LimitedEntryConditionCol52 entity = new LimitedEntryConditionCol52();
  ...
  public String marshall(LimitedEntryConditionCol52 a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.guided.dtable.shared.model.LimitedEntryConditionCol52\",\"^ObjectID\"");
