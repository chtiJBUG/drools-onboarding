...
public class Marshaller_o_d_d_e_DataSetDefRemovedEvent_1_Impl implements GeneratedMarshaller<DataSetDefRemovedEvent> {
  ...
  public String marshall(DataSetDefRemovedEvent a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.dashbuilder.dataset.events.DataSetDefRemovedEvent\",\"^ObjectID\"");
