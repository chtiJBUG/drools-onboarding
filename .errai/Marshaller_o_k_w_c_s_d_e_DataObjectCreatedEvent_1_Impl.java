...
public class Marshaller_o_k_w_c_s_d_e_DataObjectCreatedEvent_1_Impl implements GeneratedMarshaller<DataObjectCreatedEvent> {
  private DataObjectCreatedEvent[] EMPTY_ARRAY = new DataObjectCreatedEvent[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public DataObjectCreatedEvent[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public DataObjectCreatedEvent demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataObjectCreatedEvent.class, objId);
    }
    DataObjectCreatedEvent entity = new DataObjectCreatedEvent();
  ...
  public String marshall(DataObjectCreatedEvent a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.kie.workbench.common.screens.datamodeller.events.DataObjectCreatedEvent\",\"^ObjectID\"");
