...
public class Marshaller_o_d_w_m_g_d_s_m_MetadataCol52_1_Impl implements GeneratedMarshaller<MetadataCol52> {
  ...
  public MetadataCol52[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public MetadataCol52 demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(MetadataCol52.class, objId);
    }
    MetadataCol52 entity = new MetadataCol52();
    a1.recordObject(objId, entity);
    if ((obj.containsKey("metadata")) && (!obj.get("metadata").isNull())) {
      entity.setMetadata(java_lang_String.demarshall(obj.get("metadata"), a1));
    }
