...
public class Marshaller_o_j_c_n_b_e_DeploymentException_1_Impl implements GeneratedMarshaller<DeploymentException> {
  private DeploymentException[] EMPTY_ARRAY = new DeploymentException[0];
  ...
  public DeploymentException[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public DeploymentException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DeploymentException.class, objId);
    }
    DeploymentException entity = new DeploymentException();
  ...
  public String marshall(DeploymentException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jbpm.console.ng.bd.exception.DeploymentException\",\"^ObjectID\"");
