...
public class Marshaller_o_d_w_m_d_r_ExpressionText_1_Impl implements GeneratedMarshaller<ExpressionText> {
  private ExpressionText[] EMPTY_ARRAY = new ExpressionText[0];
  private Marshaller java_lang_Object = Marshalling.getMarshaller(Object.class);
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  public ExpressionText[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public ExpressionText demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ExpressionText.class, objId);
    }
    ExpressionText entity = new ExpressionText();
  ...
  public String marshall(ExpressionText a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.drools.workbench.models.datamodel.rule.ExpressionText\",\"^ObjectID\"");
