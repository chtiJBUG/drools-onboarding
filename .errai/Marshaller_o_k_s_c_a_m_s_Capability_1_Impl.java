...
public class Marshaller_o_k_s_c_a_m_s_Capability_1_Impl implements GeneratedMarshaller<Capability> {
  ...
  public String marshall(Capability a0, MarshallingSession a1) {
    ...
    return json.append(a0 != null ? new StringBuilder(64).append("{\"^EncodedType\":\"org.kie.server.controller.api.model.spec.Capability\",\"^EnumStringValue\":\"").append(a0.name()).append("\"}") : "null").toString();
  }
