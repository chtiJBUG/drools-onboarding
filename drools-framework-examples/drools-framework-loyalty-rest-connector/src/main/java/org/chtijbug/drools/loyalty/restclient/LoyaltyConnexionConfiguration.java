 ...
 */
package org.chtijbug.drools.loyalty.restclient;
 ...
 * Time: 09:05
 */
public class LoyaltyConnexionConfiguration {
    ...
    private LoyaltyRestAPI loyaltyPoolRestAPI;

    public LoyaltyConnexionConfiguration(String baseUrl, String userName, String password) {
    ...
    public LoyaltyRestAPI getLoyaltyRestAPI() {
        ...
        loyaltyPoolRestAPI = target.proxy(LoyaltyRestAPI.class);
