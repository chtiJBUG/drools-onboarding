...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-7 col-md-6 col-lg-5 login">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/kie-drools-wb.html"
                  method="GET">
                <div class="form-group">
                    <div class="col-xs-offset-8 col-xs-4 col-sm-offset-8 col-sm-4 col-md-offset-8 col-md-4 submit">
                        <button type="submit" class="btn btn-primary btn-lg" tabindex="1"><i18n:message
                                key="loginAsAnotherUser">Login as another user</i18n:message></button>
                    </div>
                </div>
            </form>
        </div>
