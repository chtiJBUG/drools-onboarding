...
(function (P, T, q) {
    ...
    function Db(b) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", function (b,
                                                                                                                                                                j, k, l, n, o, p, s, t) {
            function x(a, b, c) {
            ...
            function R(a, b, c, d, e, j, h) {
                var i = [], k, o, p = c[0], t = a.shift(), s = v({}, t, {
                    controller: null,
                    templateUrl: null,
                    transclude: null,
                    scope: null
    ...
    function Lc(b, a) {
        ...
        for (var n = [], o, p = 0, s = [], t, x = ":"; p < b.length;) {
            ...
            }), c("{[") && s.unshift(t), c("}]") && s.shift(), p++; else if (g(t)) {
                p++;
                continue
            } else {
                var m = t + d(), A = Ia[t], N = Ia[m];
                N ? (n.push({index: p, text: m, fn: N}), p += 2) : A ? (n.push({
                    index: p,
                    text: t,
                    fn: A,
                    json: "[,:".indexOf(x) != -1 && c("+-")
    ...
    }, Ba = K.cache = {}, Aa = K.expando = "ng-" + (new Date).getTime(), oc = 1, $b = P.document.addEventListener ?
        function (b, a, c) {
    ...
    }, mc = /([\:\-\_]+(.))/g, nc = /^moz([A-Z])/, ua = K.prototype = {
        ready: function (b) {
            function a() {
                c || (c = !0, b())
            }
    ...
    m({
        data: wb, inheritedData: Da, scope: function (b) {
            return Da(b, "$scope")
    ...
    Db.$inject = ["$provide"];
    var Bc = /^(x[\:\-_]|data[\:\-_])/i, Hb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?(\{?[\w\.-]*\}?)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, ac = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Ic = ac, Ib = {
        http: 80,
        https: 443,
        ftp: 21
    };
    ...
    var Ia = {
        ...
        "'": "'",
        '"': '"'
    }, ib = {}, Zc = P.XMLHttpRequest || function () {
            try {
    ...
    var Pa = function (a) {
        ...
        od = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/, pd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, bc = {
            ...
            return {
                require: ["ngModel", "^?form"], controller: qd, link: function (a, c, d, e) {
                    var g = e[0], h = e[1] || Ma;
                    h.$addControl(g);
        ...
        }], zd = kb("", !0), Ad = kb("Odd", 0), Bd = kb("Even", 1), Cd = S({
    ...
    }], Ud = I({terminal: !0}), Vd = ["$compile", "$parse", function (a,
                                                                      c) {
                    ...
                    function h() {
                        ...
                        for (w = c.length; x < w; x++) {
                            ...
                            if (r.length <= x)s = {
                                ...
                                label: i.label
                            }, u = [s], r.push(u), f.append(s.element); else if (u =
