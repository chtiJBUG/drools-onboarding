...
<div id="pfly-login-screen">
    <img id="logo" src="<%= request.getContextPath() %>/images/kie-ide.png" alt="KIE IDE Logo"
         title="Powered By Drools/jBPM"/>
            ...
            <form action="<%= request.getContextPath() %>/kie-drools-wb.html" method="GET">
                ...
                <p>
                    ...
                    <input class="button" type="submit"
                           value='<i18n:message key="loginAsAnotherUser">Login as another user</i18n:message>'/>
                </p>
            </form>
        </div>
    </div>
