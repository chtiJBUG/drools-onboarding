...
public interface OrganizationalUnitManagerPresenter {
    ...
    void addOrganizationalUnitGroup( final OrganizationalUnit organizationalUnit,
                                          final String group );

    void removeOrganizationalUnitGroup( final OrganizationalUnit organizationalUnit,
                                             final String group );
